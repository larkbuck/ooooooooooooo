...
! function(t) {
  ...
  c.distance = function(t, e) {
    ...
    var e, i, n, o = t.angle.radian,
      r = Math.PI / 4,
      s = Math.PI / 2;
    if (e = o > r && o < 3 * r ? "up" : o > -r && o <= r ? "left" : o > 3 * -r && o <= -r ? "down" : "right", i = o > -s && o < s ? "left" : "right", n = o > 0 ? "up" : "down", t.force > this.options.threshold) {
      var d = {};
    ...
    var r = o.options.size / 2,
      ...
      p = c.radians(a),
      l = d / r;
    d > r && (d = r, s = c.findCoord(o.position, d, a)), o.frontPosition = {
      x: s.x - o.position.x,
      y: s.y - o.position.y
    ...
    u = o.computeDirection(u), u.angle = {
      radian: c.radians(180 - a),
      degree: 180 - a
    }, o.trigger("move", u), e.trigger("move " + o.id + ":move", u)
